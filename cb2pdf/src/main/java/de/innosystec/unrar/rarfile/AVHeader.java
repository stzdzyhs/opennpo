...
public class AVHeader extends BaseBlock {
	...
	public void setAvInfoCRC(int avInfoCRC) {
		this.avInfoCRC = avInfoCRC;
	}
	public byte getAvVersion() {
		return avVersion;
	}
	public void setAvVersion(byte avVersion) {
	...
	public void setUnpackVersion(byte unpackVersion) {
		this.unpackVersion = unpackVersion;
	}
