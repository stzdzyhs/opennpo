...
function Rounded(className, sizex, sizey, sizex_b, sizey_b, pod ) {
	var bk;
	...
	for (var i = 0; i < l; i++) {
		...
		v[i].innerHTML = "<div style='padding: 0px "+pod+"px 0px "+pod+"px'>" + v[i].innerHTML + "</div>";
...
function RecolorRounded(el, bk, color) {
	var o = el.getElementsByTagName('div');
	var oldcolor = null;
	for (var i = 0; i < o.length; i++) {
		if (o[i].style && o[i].style.backgroundColor)
		{
			if (!oldcolor)
				oldcolor = o[i].style.backgroundColor;

			if (o[i].style.backgroundColor == oldcolor)
				o[i].style.backgroundColor = bk;
		}
	}
}
